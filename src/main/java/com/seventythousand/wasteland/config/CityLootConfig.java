...
public class CityLootConfig {
  ...
  public static void load(Configuration config) {
    ...
    midLoot = config.get("Loot List", "Uncommon chest loot items", new String[] { "minecraft:bucket,1,1,3", "hbm:item.canister_empty,3,2,5", "minecraft:potion,12,6,7", "hbm:item.horseshoe_magnet,1,1,1", "minecraft:paper,20,10,4", "hbm:item.pill_herbal,2,1,4", "hbm:tile.deco_crt,1,1,1", "hbm:item.coffee,3,1,4", "hbm:tile.radiorec,1,1,1", "hbm:item.cigarette,6,2,6", "hbm:item.screwdriver,1,1,2", "hbm:item.rag,6,2,4", "hbm:item.plant_item:1,6,2,4", "hbm:item.coffee,3,1,4", "hbm:item.radx,3,1,4", "hbm:item.lodestone,1,1,3" }).getStringList();
    hardLoot = config.get("Loot List", "Rare chest loot items", new String[] { "hbm:tile.radiorec,3,2,6",  "hbm:item.jackt,1,1,1", "hbm:item.syringe_metal_stimpak,6,4,7", "minecraft:diamond,2,1,6", "hbm:item.siphon,1,1,2", "hbm:item.blowtorch,1,1,2", "hbm:item.boltgun,1,1,1", "hbm:item.defuser,1,1,2", "hbm:item.weapon_saw,1,1,2", "hbm:item.bolt:30,24,12,6", "hbm:item.bolt:33,24,12,6", "hbm:item.canister_full:20,4,1,6", "hbm:item.canister_full:20,4,1,6", "hbm:tile.deco_crt,3,1,4",  "hbm:item.serum,1,1,1",  "hbm:item.spider_milk,1,1,1",  "hbm:tile.deco_computer,3,1,2",  "hbm:item.weapon_golf_club,1,1,3",  "hbm:item.med_bag,1,1,3",  "hbm:item.siox,1,1,3", "hbm:item.bandaid,1,1,2"}).getStringList();
