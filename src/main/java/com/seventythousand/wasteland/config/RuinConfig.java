    ...
    public static void load(Configuration config) {
        ...
        midLoot = config.get("Loot List", "Uncommon village chest loot items",
            new String[]{
                ...
                "minecraft:potion,4,2,4",
                "hbm:item.horseshoe_magnet,1,1,4",
                "hbm:item.weapon_saw,1,1,4",
                "minecraft:paper,20,10,5",
                "hbm:item.canister_full:20,3,2,4",
                ...
                "hbm:item.bolt:30,24,12,4", "hbm:item.casing,8,4,5", "hbm:item.casing:1,8,4,5", "hbm:item.casing:5,8,4,5",
                ...
                "hbm:item.steel_pickaxe:60,1,1,3", "hbm:item.steel_shovel:20,1,1,3", "hbm:item.steel_axe:20,1,1,3",
        ...
        hardLoot = config.get("Loot List", "Rare village chest loot items",
            new String[]{
                ...
                "hbm:item.bolt:33,24,12,4",//gun parts
        ...
        ruinRareLoot = config.get("Loot List", "Rare ruins chest loot items",
            new String[]{"hbm:item.plate_copper,4,2,2",
                ...
                "hbm:item.ammo_standard:5,16,8,6",
                "hbm:item.ammo_standard:15,16,8,6",
                "hbm:item.ammo_standard:23,32,16,9",
                "hbm:item.weapon_bat,1,1,3",
                "hbm:item.crowbar,1,1,4",
                "hbm:item.casing,8,4,5",
                "hbm:item.casing:1,8,4,5",
                "hbm:item.robes_helmet,1,1,6",
                "hbm:item.robes_plate,1,1,6",
                "hbm:item.robes_legs,1,1,6",
                "hbm:item.robes_boots,1,1,6",
        ...
        ruinHardLoot = config.get("Loot List", "Hard ruins chest loot items", new String[]{
            ...
            "hbm:item.ammo_standard:9,16,8,6",
            "hbm:item.ammo_standard:15,16,8,6",
            "hbm:item.ammo_standard:23,32,16,9",
            "hbm:item.ammo_standard:18,64,32,4",
            "hbm:item.ammo_standard:12,16,5,6",
            "hbm:item.ammo_standard:42,16,5,6",
