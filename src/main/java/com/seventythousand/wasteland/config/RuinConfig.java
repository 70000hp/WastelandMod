...
public class RuinConfig {
    ...
    public static void load(Configuration config) {
        ...
        midLoot = config.get("Loot List", "Uncommon village chest loot items", new String[]{"minecraft:bucket,1,1,3", "minecraft:carrot,2,2,2", "hbm:item.canister_empty,3,2,5", "hbm:item.battery_advanced,1,1,4", "minecraft:potion,12,6,7", "hbm:item.horseshoe_magnet,1,1,1", "hbm:item.weapon_saw,1,1,2", "minecraft:paper,20,10,4", "hbm:item.canister_full:20,1,1,2", "hbm:item.ammo_standard:13,8,6,2", "hbm:item.ammo_standard:5,8,6,2", "hbm:item.ammo_standard:44,12,5,4", "hbm:item.part_mechanism:49,2,1,1", "hbm:item.part_receiver_light:30,2,1,1", "hbm:item.part_receiver_light:49,2,1,1", "hbm:item.part_barrel_light:30,2,1,1", "hbm:item.pill_herbal,2,1,4", "hbm:tile.deco_crt,1,1,1", "hbm:item.gun_kit_1,3,1,4", "hbm:tile.radiorec,1,1,1", "hbm:item.cigarette,6,2,6", "hbm:item.screwdriver,1,1,2", "hbm:item.rag,6,2,4", "hbm:item.plant_item:1,6,2,4"}).getStringList();
        hardLoot = config.get("Loot List", "Rare village chest loot items", new String[]{"hbm:item.cheese,14,12,6", "hbm:item.loops,10,8,8", "hbm:item.gun_maresleg,1,1,1", "hbm:item.fuel_additive,3,1,1", "hbm:item.gun_henry,1,1,1", "hbm:item.bathwater,1,1,8",  "hbm:item.ammo_standard:25,10,8,5",  "hbm:item.ammo_standard:26,16,8,5", "hbm:item.ammo_standard:29,16,8,6", "hbm:item.part_mechanism:49,2,1,1", "hbm:item.part_receiver_light:30,4,2,1", "hbm:item.part_receiver_light:49,3,2,1", "hbm:item.bolt:30,24,12,1", "hbm:item.ammo_standard:42,12,5,4", "hbm:item.part_barrel_heavy:33,2,1,1", "hbm:tile.deco_toaster,1,1,4", "hbm:item.battery_advanced_cell_4,1,1,1", "hbm:item.siox,3,2,6", "hbm:item.radx,3,2,6", "hbm:item.syringe_metal_medx,4,2,6", "hbm:item.syringe_metal_stimpak,4,3,6", "hbm:item.syringe_metal_psycho,3,2,6","hbm:tile.deco_crt,4,2,2",}).getStringList();
        ruinEasyLoot = config.get("Loot List", "Common ruins chest loot items", new String[]{"hbm:item.canned_conserve,3,2,12", "hbm:item.powder_sawdust,6,4,10", "minecraft:gunpowder,5,2,5", "minecraft:string,12,2,9", "minecraft:potion,5,2,7", "hbm:item.canned_conserve:2,3,1,2", "hbm:item.canned_conserve:3,3,2,7", "hbm:item.canned_conserve:14,3,2,12", "minecraft:paper,12,5,3", "hbm:item.bottle_nuka,5,2,2", "hbm:item.cap_nuka,12,6,7", "hbm:item.ammo_standard:4,12,5,4", "hbm:item.ammo_standard:1,12,5,4", "hbm:item.dust,12,2,10", "hbm:item.gas_mask_m65:60,1,1,2", "hbm:item.gas_mask_filter_piss,1,1,7", "hbm:item.gas_mask_olde:90,1,1,3", "hbm:item.plant_item:1,6,2,7"}).getStringList();
        ...
        ruinHardLoot = config.get("Loot List", "Hard ruins chest loot items", new String[]{"hbm:item.part_barrel_light:33,3,2,2", "hbm:item.pipe:30,2,1,2", "hbm:item.definitelyfood,12,3,6", "hbm:item.fuel_additive,3,1,3", "hbm:tile.machine_diesel,1,1,6", "hbm:tile.mine_ap,3,2,3", "hbm:tile.red_barrel,3,2,6", "hbm:item.cordite,24,16,6", "hbm:item.boltgun:2,3,1,2", "hbm:item.sopsign,1,1,1", "hbm:item.weapon_golf_club,1,1,3", "hbm:item.ammo_standard:50,8,4,5", "hbm:item.ammo_standard:51,2,1,6","hbm:item.ammo_standard:22,20,5,3", "hbm:item.ammo_standard:30,8,5,3", "hbm:item.ammo_standard:47,12,6,3", "hbm:item.steel_plate,1,1,3", "hbm:item.robes_helmet,1,1,6", "hbm:item.robes_plate,1,1,6", "hbm:item.robes_legs,1,1,6", "hbm:item.robes_boots,1,1,6", "hbm:item.jackt,1,1,1", "hbm:item.gas_mask_m65,1,1,4", "hbm:item.gas_mask_filter,1,1,6", "hbm:tile.deco_crt,1,1,2", "hbm:tile.filing_cabinet,1,1,5"}).getStringList();
        ...
        startLoot = config.get("Loot List", "Start bunker chest loot items", new String[]{"hbm:item.weapon_bat:20,1,1", "hbm:item.steel_pickaxe:60,1,1", "hbm:item.steel_shovel:20,1,1", "hbm:item.steel_axe:20,1,1", "hbm:item.definitelyfood,18,12", "hbm:item.robes_helmet,1,1", "hbm:item.robes_plate,1,1", "hbm:item.robes_legs,1,1", "hbm:item.robes_boots,1,1"}).getStringList();
        ...
        rareRuinLootChance = config.getInt("Uncommon ruin loot chance", "Loot Rarity", 6, 1, 10000, "If not picked, defaults to common ruin chest loot");
        hardRuinLootChance = config.getInt("Hard ruin loot chance", "Loot Rarity", 12, 1, 10000, "If not picked, defaults to common ruin chest loot");
        config.save();
    }
