...
public class RuinConfig {
    ...
    public static void load(Configuration config) {
        ...
        startLootMax = config.getInt("Bunker chest items MAX", "Loot Amount", 54, 0, 54, "Items in spawn bunker chest (if enabled)");
        startLootMin = config.getInt("Bunker chest items MIN", "Loot Amount", 50, 0, 53, "");
        ...
        easyLoot = config.get("Loot List", "Common village chest loot items", new String[]{"hbm:item.canned_conserve,2,1,12", "hbm:item.powder_sawdust,12,4,10", "minecraft:potato,3,2,1", "minecraft:string,9,2,9", "minecraft:potion,3,1,12", "hbm:item.canned_conserve:2,2,1,6", "hbm:item.canned_conserve:3,2,2,10", "hbm:item.canned_conserve:20,4,3,2", "minecraft:paper,12,5,3", "hbm:item.bottle_nuka,5,2,2", "hbm:item.dust,12,2,8", "hbm:item.can_smart,4,2,5"}).getStringList();
        midLoot = config.get("Loot List", "Uncommon village chest loot items", new String[]{"minecraft:bucket,1,1,3", "minecraft:carrot,2,2,2", "hbm:item.canister_empty,3,2,5", "hbm:item.battery_advanced,1,1,4", "minecraft:potion,12,6,7", "hbm:item.horseshoe_magnet,1,1,1", "hbm:item.weapon_saw,1,1,2", "minecraft:paper,20,10,4", "hbm:item.canister_full:20,1,1,2", "hbm:item.ammo_standard:13,8,6,2", "hbm:item.ammo_standard:5,8,6,2", "hbm:item.ammo_standard:42,12,5,4", "hbm:item.pipe:2600,4,2,6", "hbm:item.part_receiver_light:30,2,1,1", "hbm:item.part_receiver_light:49,2,1,1", "hbm:item.part_barrel_light:30,2,1,1", "hbm:item.pill_herbal,2,1,4", "hbm:tile.deco_crt,3,1,4", "hbm:item.gun_kit_1,3,1,4","hbm:item.steel_pickaxe:60,1,1,3", "hbm:item.steel_shovel:20,1,1", "hbm:item.steel_axe:20,1,1", "hbm:tile.radiorec,1,1,3", "hbm:item.cigarette,6,2,6", "hbm:item.screwdriver,1,1,2", "hbm:item.rag,6,2,4", "hbm:item.plant_item:1,6,2,4"}).getStringList();
        hardLoot = config.get("Loot List", "Rare village chest loot items", new String[]{"hbm:item.cheese,14,12,6", "hbm:item.loops,10,8,8", "hbm:item.gun_maresleg,1,1,1", "hbm:item.fuel_additive,3,1,1", "hbm:item.gun_henry,1,1,1", "hbm:item.bathwater,1,1,8", "hbm:item.siphon,1,1,1", "hbm:item.blowtorch,1,1,1", "hbm:item.boltgun,1,1,1", "hbm:item.defuser,1,1,1", "hbm:item.heart_piece,1,1,1",  "hbm:item.ammo_standard:25,10,8,5",  "hbm:item.ammo_standard:26,16,8,5", "hbm:item.ammo_standard:29,16,8,6", "hbm:item.part_mechanism:49,2,1,1", "hbm:item.part_receiver_light:30,4,2,1", "hbm:item.bolt:30,24,12,1", "hbm:item.ammo_standard:42,12,5,4", "hbm:item.part_barrel_heavy:33,2,1,1", "hbm:tile.deco_toaster,1,1,4", "hbm:item.battery_advanced_cell_4,1,1,1", "hbm:item.siox,3,2,6", "hbm:item.radx,3,2,6", "hbm:item.syringe_metal_medx,4,2,6", "hbm:item.syringe_metal_stimpak,4,3,6", "hbm:item.syringe_metal_psycho,3,2,6",  "hbm:item.med_bag,1,1,3","hbm:tile.deco_crt,4,2,2", "hbm:item.bandaid,1,1,2",}).getStringList();
