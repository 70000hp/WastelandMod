    ...
    public boolean generate(World world, Random rand, int x, int y, int z) {
        ...
        if (y >= 1 && y + l + 1 <= 256) {
            ...
            if (!flag) {
                ...
                boolean isSoil = block2.equals(ModConfig.getSurfaceBlock())
                    || ((log == ModBlocks.waste_log || log == ModBlocks.frozen_log) && !(block2.equals(ModBlocks.waste_log) || block2.equals(ModBlocks.frozen_log)));
                ...
                if (isSoil && y < 256 - l - 1) {
                    ...
                    int j2;
                    int i3;
                    if (leaves && !(log == ModBlocks.waste_log || log == ModBlocks.frozen_log)) {
