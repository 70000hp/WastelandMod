...
public class CityLootConfig {
  ...
  public static void load(Configuration config) {
    ...
    midLootChance = config.getInt("Uncommon city loot chance", "Loot Rarity", 6, 1, 10000, "If not picked, defaults to common loot");
    hardLootChance = config.getInt("Rare city loot chance", "Loot Rarity", 8, 1, 10000, "If not picked, checks rarity of uncommon loot");
    ultraLootChance = config.getInt("Ultra rare city loot chance ", "Loot Rarity", 20, 1, 10000, "If not picked, checks rarity of rare loot");
    config.save();
  }
