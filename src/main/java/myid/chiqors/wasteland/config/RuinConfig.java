...
public class RuinConfig {
  ...
  public static void load(Configuration config) {
    ...
    seedLoot = config.get("Loot List", "Ruins seed chest loot items", new String[] { "minecraft:wheat_seeds,3,1" }).getStringList();
    startLoot = config.get("Loot List", "Start bunker chest loot items", new String[] { "minecraft:stone_sword:20,1,1", "minecraft:bread,2,2", "minecraft:leather_helmet,1,1", "minecraft:leather_boots,1,1", "minecraft:cooked_chicken,3,2", "minecraft:glass_bottle,2,1" }).getStringList();
    ...
    midLootChance = config.getInt("Uncommon village loot chance", "Loot Rarity", 8, 1, 10000, "If not picked, defaults to common village chest loot");
    hardLootChance = config.getInt("Rare village loot chance", "Loot Rarity", 32, 1, 10000, "If not picked, checks rarity of uncommon village chest loot");
