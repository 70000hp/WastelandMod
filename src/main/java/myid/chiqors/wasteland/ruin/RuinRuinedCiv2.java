        ...
        if (!flag2) {
          for (int l2 = 1; l2 <= 3; l2++) {
            for (int j3 = 0; j3 < 80; j3++) {
              RuinGenHelper.setBlock(i + k1, j + l2, k + j1, Blocks.air);
              k1++;
              if (k1 == 8) {
                j1++;
                k1 = 0;
          ...
          for (int j5 = 0; j5 < 4; j5++) {
            for (int l6 = 0; l6 < 8; l6++)
              RuinGenHelper.setBlock(i + l6, j + j5, k, l1); 
            for (int i7 = 0; i7 < 9; i7++)
              RuinGenHelper.setBlock(i + i7, j + j5, k + 10, l1); 
            for (int j7 = 0; j7 < 10; j7++)
              RuinGenHelper.setBlock(i, j + j5, k + j7, l1); 
            for (int k7 = 0; k7 < 10; k7++)
              RuinGenHelper.setBlock(i + 8, j + j5, k + k7, l1); 
          } 
          if (i4 > 0)
            for (int k5 = 0; k5 < 4; k5++) {
              for (int l7 = 0; l7 < 8; l7++)
                RuinGenHelper.setBlock(i + l7, j + k5 + 4, k, l1); 
              for (int i8 = 0; i8 < 9; i8++)
                RuinGenHelper.setBlock(i + i8, j + k5 + 4, k + 10, l1); 
              for (int j8 = 0; j8 < 10; j8++)
                RuinGenHelper.setBlock(i, j + k5 + 4, k + j8, l1); 
              for (int k8 = 0; k8 < 10; k8++)
                RuinGenHelper.setBlock(i + 8, j + k5 + 4, k + k8, l1); 
            }  
          if (i4 > 1)
            for (int l5 = 0; l5 < 4; l5++) {
              for (int l8 = 0; l8 < 8; l8++)
                RuinGenHelper.setBlock(i + l8, j + l5 + 8, k, l1); 
              for (int i9 = 0; i9 < 9; i9++)
                RuinGenHelper.setBlock(i + i9, j + l5 + 8, k + 10, l1); 
              for (int j9 = 0; j9 < 10; j9++)
                RuinGenHelper.setBlock(i, j + l5 + 8, k + j9, l1); 
              for (int k9 = 0; k9 < 10; k9++)
                RuinGenHelper.setBlock(i + 8, j + l5 + 8, k + k9, l1); 
            }  
          j4 = 0;
          k4 = 0;
          if (i4 > 0)
          ...
          if (k6 == 0) {
            if (i4 >= 1) {
              ...
              for (int j12 = 0; j12 < 63; j12++) {
                if (l9 == 0 || l9 == 6)
                  RuinGenHelper.setBlock(i + l9 + 1, j + 5, k + i11 + 1, Blocks.bookshelf); 
                if (i11 == 0 || i11 == 8)
                  RuinGenHelper.setBlock(i + l9 + 1, j + 5, k + i11 + 1, Blocks.bookshelf); 
                i11++;
                if (i11 == 9) {
            ...
            if (i4 > 2) {
              ...
              for (int k12 = 0; k12 < 63; k12++) {
                if (i10 == 0 || i10 == 6)
                  RuinGenHelper.setBlock(i + i10 + 1, j + 9, k + j11 + 1, Blocks.furnace); 
                if (j11 == 0 || j11 == 8)
                  RuinGenHelper.setBlock(i + i10 + 1, j + 9, k + j11 + 1, Blocks.furnace); 
                j11++;
                if (j11 == 9) {
            ...
            if (i4 >= 1)
              for (int j10 = 0; j10 < 3; j10++) {
                ...
                for (int j13 = 0; j13 < 63; j13++) {
                  if (k11 == 0 || k11 == 6)
                    RuinGenHelper.setBlock(i + k11 + 1, j + 5 + j10, k + l12 + 1, Blocks.bookshelf); 
                  if (l12 == 0 || l12 == 8)
                    RuinGenHelper.setBlock(i + k11 + 1, j + 5 + j10, k + l12 + 1, Blocks.bookshelf); 
                  l12++;
                  if (l12 == 9) {
            ...
            if (i4 >= 2) {
              for (int k10 = 0; k10 < 3; k10++) {
                ...
                for (int k13 = 0; k13 < 63; k13++) {
                  if (l11 == 0 || l11 == 6)
                    RuinGenHelper.setBlock(i + l11 + 1, j + 9 + k10, k + i13 + 1, Blocks.bookshelf); 
                  if (i13 == 0 || i13 == 8)
                    RuinGenHelper.setBlock(i + l11 + 1, j + 9 + k10, k + i13 + 1, Blocks.bookshelf); 
                  i13++;
                  if (i13 == 9) {
