...
public class BiomeGenWastelandMesa extends BiomeGenWastelandBase {
  ...
  public BiomeGenWastelandMesa(int par1ID, String par2Name, Height par3BiomeHeight, boolean alive) {
            ...
            if (j1 == -1)
            {
              ...
              if (l1 >= 62)
              {
                if (bryce && l1 > 86 + i1 * 2)
                {
                  ...
                  {
                    p_150573_3_[i2] = ModConfig.getSurfaceBlock();
                  }
                }
                else if (l1 > 66 + i1)
                {
  ...
  {
    int l = (int)Math.round(this.field_150625_aG.func_151601_a((double) p_150618_1_ / 512.0D, (double) p_150618_1_ / 512.0D) * 2.0D);
