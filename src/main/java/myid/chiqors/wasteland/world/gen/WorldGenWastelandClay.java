...
public class WorldGenWastelandClay extends WorldGenerator {
  ...
  public boolean generate(World p_76484_1_, Random p_76484_2_, int p_76484_3_, int p_76484_4_, int p_76484_5_) {
    ...
    for (int i = 0; i < 10; i++) {
      if (p_76484_1_.getBlock(p_76484_3_, p_76484_4_ - i, p_76484_5_) instanceof myid.chiqors.wasteland.items.BlockRadFluid)
        if (!(p_76484_1_.getBlock(p_76484_3_, p_76484_4_ - i - 1, p_76484_5_) instanceof myid.chiqors.wasteland.items.BlockRadFluid)) {
          generateClay = true;
          p_76484_4_ -= i;
        }  
    } 
      ...
      for (int j1 = p_76484_5_ - l; j1 <= p_76484_5_ + l; j1++) {
        ...
        if (k1 * k1 + l1 * l1 <= l * l)
          for (int i2 = p_76484_4_ - b0; i2 <= p_76484_4_ + b0; i2++) {
            ...
            if (block != Blocks.air && !(block instanceof myid.chiqors.wasteland.items.BlockRadFluid) && topBlock != Blocks.air)
