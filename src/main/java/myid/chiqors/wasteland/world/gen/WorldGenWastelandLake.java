    ...
    for (i1 = 0; i1 < 16; i1++) {
      for (int j2 = 0; j2 < 16; j2++) {
        for (int j1 = 4; j1 < 8; j1++) {
          if (aboolean[(i1 * 16 + j2) * 8 + j1] && p_76484_1_.getBlock(p_76484_3_ + i1, p_76484_4_ + j1 - 1, p_76484_5_ + j2) == ModConfig.getSurfaceBlock() && p_76484_1_.getSavedLightValue(EnumSkyBlock.Sky, p_76484_3_ + i1, p_76484_4_ + j1, p_76484_5_ + j2) > 0)
            p_76484_1_.setBlock(p_76484_3_ + i1, p_76484_4_ + j1 - 1, p_76484_5_ + j2, ModConfig.getSurfaceBlock(), 0, 2); 
        } 
      } 
    } 
