package myid.chiqors.wastelands.entity;
...
public class EntityDayZombie extends EntityMob
{
    ...
    public IEntityLivingData onSpawnWithEgg(IEntityLivingData p_110161_1_)
    {
        ...
        {
            p_110161_1_1 = new EntityDayZombie.GroupData(this.worldObj.rand.nextFloat() < ForgeModContainer.zombieBabyChance, this.worldObj.rand.nextFloat() < 0.05F, null);
        }

        if (p_110161_1_1 instanceof EntityDayZombie.GroupData)
        {
            EntityDayZombie.GroupData groupdata = (EntityDayZombie.GroupData)p_110161_1_1;
    ...
    {
    	//System.out.println(String.valueOf(this.worldObj.getLightBrightness(p_70783_1_, p_70783_2_, p_70783_3_)));
    ...
    {
    	//System.out.println("Light at " + String.valueOf(this.posX) + " " + String.valueOf(this.posY) + " " +String.valueOf(this.posZ));
    	//return true;
    	
    	if ((((int)(this.worldObj.getWorldTime()/12000)) & 1) == 1) //if night-time
    	{
    		return false;
    	}
