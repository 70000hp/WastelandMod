...
{
    public static ArrayList<BiomeGenBase> allowedBiomes = new ArrayList<BiomeGenBase>(Arrays.asList(WastelandBiomes.apocalypse, WastelandBiomes.mountains, WastelandBiomes.forest));
    ...
    public WorldChunkManagerWasteland(World p_i1976_1_)
    {
